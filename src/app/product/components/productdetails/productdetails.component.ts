...
export class ProductdetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.product = {
      ...
      productPrice: 125.00,
      productImages: [
        'E-commerce-product-page-master/docs/assets/images/image-product-1.jpg',
        'E-commerce-product-page-master/docs/assets/images/image-product-2.jpg',
        'E-commerce-product-page-master/docs/assets/images/image-product-3.jpg',
        'E-commerce-product-page-master/docs/assets/images/image-product-4.jpg'
      ],
